...
struct ContentView: View {
    ...
    @State var data = [Data]()
    let Regions = [ String("NAE"), String("NAW"), String("NAC"), String("ME"), String("EU"), String("ASIA"), String("OCE"), String("BR")]
    @State private var showingAlert = false
    
    var body: some View {
        NavigationView{
            List(Regions,id: \.self){
                region in NavigationLink(destination: Region_View()){
                    Text(region)
                }
            }
